...
\vspace{-10pt}
    \centering
    \subfloat[\label{fig:brca_dot:a}]{{\includegraphics[width=0.7\textwidth]{pdf_figs/HCC1187_dotplot.pdf} }}%
    %
    \subfloat[\label{fig:brca_dot:b}]{{\includegraphics[width=0.18\textwidth]{pdf_figs/position_lookup_chart.pdf} }}%

...
Figure~\ref{fig:brca_MAF} shows the estimated minor allele frequencies for the normal and tumor samples at the called locations. Positions chr7:743899XC$>$T, chr7:753635T$>$C and chr7:780960C$>$T are germline homozygous mutations. Positions chr7:754371 and chr7:758813 are called heterozygous in the normal sample. In the tumor cells we identified all five mutations chr7:743899C$>$T, chr7:753635T$>$C, chr7:754371T$>$C, chr7:758813G$>$A, and chr7:780960C$>$T. Positions chr7:754371T$>$C and chr7:758813G$>$A are identified as loss-of-heterozygosity events.

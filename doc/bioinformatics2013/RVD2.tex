...
Figure~\ref{fig:brca_MAF} shows the estimated minor allele frequencies for the normal and tumor samples at the called locations. Positions chr7:743899XC$\rightarrow$T, chr7:753635T$\rightarrow$C and chr7:780960C$\rightarrow$T are germline homozygous mutations. Positions chr7:754371 and chr7:758813 are called heterozygous in the normal sample. In the tumor cells we identified all five mutations chr7:743899C$\rightarrow$T, chr7:753635T$\rightarrow$C, chr7:754371T$\rightarrow$C, chr7:758813G$\rightarrow$A, and chr7:780960C$\rightarrow$T. Positions chr7:754371T$\rightarrow$C and chr7:758813G$\rightarrow$A are identified as loss-of-heterozygosity events.

% TODO: replace X>X with the reference and mutated base here
% Done
...
The original research describing this sample used Strelka to identify mutations in the same sample. They identified chr7:154760439 as variant, but missed the other four variants.

...
try:
    ...
    controlFileList = ["../2013-08-06_Downsample_Read_Depth/depth_chart/100000/%s" % filename for filename in toc.Filename[toc.isRef=='Y']]
...
for dilution in np.unique(toc[toc.isRef=='N'].Dilution):
    ...
    try:
        ...
        caseFileList = ["../2013-08-06_Downsample_Read_Depth/depth_chart/100000/%s" % filename for filename in toc.Filename[toc.Dilution==dilution]]

...
samtools view -u $BAMCONTROL chr7:154738059-154782774 > HCC1187BL_S1.part.bam
samtools view -u $BAMCASE chr7:154738059-154782774 > HCC1187C_S1.part.bam
...
echo -------------------------
echo mpileup
samtools mpileup -C50 -f $FASTAFILE -r chr7:154738059-154782774 HCC1187BL_S1.part.sorted.bam > HCC1187BL_S1.part.pileup 
samtools mpileup -C50 -f $FASTAFILE -r chr7:154738059-154782774 HCC1187C_S1.part.sorted.bam > HCC1187C_S1.part.pileup

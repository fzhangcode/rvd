...
def write_vcf2(outputFile, loc, call, refb, altb, caseMu, controlMu):
...
##            return bound/10
    ...
    logging.debug("burn-in and thinning...")
    if burnin > 0.0:

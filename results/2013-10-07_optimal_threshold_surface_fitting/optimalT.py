...
def ROCpoints(controlFile,caseFile, path, d,N=1000, P=0.95, chi2=False):
    ...
    save_result(EDpath,Tidx1,d,controlFile,controlLocIdx,clsList,caseMu,caseR,loc,J)
    save_result(L1path,Tidx2,d,controlFile,controlLocIdx,clsList,caseMu,caseR,loc,J)
    save_result(MCCpath,Tidx3,d,controlFile,controlLocIdx,clsList,caseMu,caseR,loc,J)

    return T[Tidx1],T[Tidx2],T[Tidx3],cov
    

def save_result(path,Tidx,dilution,controlFile,controlLocIdx,clsList,caseMu,caseR,loc,J):

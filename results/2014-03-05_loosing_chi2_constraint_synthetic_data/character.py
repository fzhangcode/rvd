...
def main():
    ...
    method = {'RVD2(T=0,R=6,chi,mu0=0)':'./sixrep_vcf_no_mu0_chi2_05',
              'RVD2(T=0,R=6,chi/J,mu0=0)':'./sixrep_vcf_no_mu0_chi2_05_J',
              'RVD2(T=0,R=6,chi/J,mu0=1)':'./sixrep_vcf_mu0_chi2_05_J',
              'RVD2(T=0,R=6,chi,mu0=1)':'./sixrep_vcf_mu0_chi2_05',
              'RVD2(T=0,R=1,chi,mu0=0)':'./onerep_vcf_no_mu0_chi2_05',
              'RVD2(T=0,R=1,chi/J,mu0=0)':'./onerep_vcf_no_mu0_chi2_05_J',
              'RVD2(T=0,R=1,chi/J,mu0=1)':'./onerep_vcf_mu0_chi2_05_J',
              'RVD2(T=0,R=1,chi,mu0=1)':'./onerep_vcf_mu0_chi2_05'}

...
def main():
    ...
    for d in dilutionList:
    	...
    	for f in folderList:
            path='sixrep_vcf_mu0_chi2_05/%s' % str(10**(folderList.index(f)+1))
            ...
            rvd27.test(controlHDF5Name=controlFile,caseHDF5Name=caseFile,diffroi=(0,np.inf),N=1000,outputFile=outputFile)

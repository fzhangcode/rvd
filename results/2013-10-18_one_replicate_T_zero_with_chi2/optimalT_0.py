...
def main():
    ...
    folderList = ('2013-10-18_one_replicate_synthetic_avg10',\
                  '2013-10-18_one_replicate_synthetic_avg100',\
                  '2013-10-18_one_replicate_synthetic_avg1000',\
                  '2013-10-18_one_replicate_synthetic_avg10000')
    ...
    for d in dilutionList:
    	...
    	for f in folderList:
            ...
            rvd27.test(controlFile,caseFile,T=0.00001,N=1000,outputFile=outputFile)
